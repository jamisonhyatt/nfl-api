...
type Game struct {
	...
	Time      string `xml:"t,attr" json:"gameTime"`
	Quarter   string `xml:"q,attr" json:"quarter"`
	HomeTeam  string `xml:"h,attr" json:"homeTeam"`
	HomeScore int    `xml:"hs,attr" json:"homeScore"`
	AwayTeam  string `xml:"v,attr" json:"awayTeam"`
	AwayScore int    `xml:"vs,attr" json:"awayScore"`

	Period   string    `json:"period"` //AM PM
	DateTime time.Time `json:"gameDateTime"`
}
